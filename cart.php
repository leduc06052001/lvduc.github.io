        ...
        if(isset($_GET['place']))
                 ...
                 ?>
                    <script type="text/javascript">
                         alert("Đặt hàng thành công!! Vui lòng chuẩn bị sẵn tiền mặt khi nhân viên giao hàng đến nhà bạn,");
                    </script>
                 <?php                  
                  }
  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
          	...
          	<a class="navbar-brand" href="index.php"><img class="img-responsive" alt="Brand" src="img/logo.jpg"  style="width: 160px;margin-top: -7px;margin-left: -10px;"></a>
        </div>
                             ...
                             if($j%2==0)
                                 ...
                                 echo '                
                                      <div class="panel col-xs-12 col-sm-4 col-sm-offset-'.$offset.' col-md-4 col-md-offset-'.$offset.' col-lg-4 col-lg-offset-'.$offset.' text-center" style="color:#D67B22;font-weight:800;">
                                          <div class="panel-heading">Đơn hàng '. $i .'
                                          </div>
                        ...
                        echo ' 
                         <div class="row">
                            <div class="col-xs-9 col-xs-offset-3 col-sm-4 col-sm-offset-5 col-md-4 col-md-offset-5">
                                 <span class="text-center" style="color:#D67B22;font-weight:bold;">&nbsp &nbsp &nbsp &nbsp Giỏ hàng trống </span>
                             </div>
                         </div>
                         <div class="row">
                             <div class="col-xs-9 col-xs-offset-3 col-sm-2 col-sm-offset-5 col-md-2 col-md-offset-5">
                                  <a href="index.php" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;">Đi mua sắm</a>
                             </div>
                          </div>';
                     }               
	    }
