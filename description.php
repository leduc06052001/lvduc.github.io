    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><img alt="Brand" src="img/logo.j[jpg" style="width: 150px;margin-top: -7px;margin-left: -10px;"></a>
        </div>
        ...
        <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
            <div>
                <form role="search" action="Result.php" method="post">
                    <input type="text" name="keyword" class="form-control" placeholder="Tìm tên sách , Tác giả hoặc Danh mục" style="width:80%;margin:20px 10% 20px 10%;">
                </form>
            </div>
        </div>
   </div>
...
echo'                           <br><br><br>
                                <a id="buyLink" href="'.$target.'" class="btn btn-lg btn-danger" style="padding:15px;color:white;text-decoration:none;"> 
                                    Thêm vào giỏ hàng với giá '.$row["Price"] .' <br>
                                    <span style="text-decoration:line-through;"> RS'.$row["MRP"].'</span> 
                                    | '.$row["Discount"].'% giảm giá
                                 </a> 
...
<div class="container-fluid" id="service">
      <div class="row">
          <div class="col-sm-6 col-md-3 text-center">
               ...
               5cloud <br>
               Rất hân hạnh được giúp đỡ, Gọi cho chúng tôi <br> 0842 884 883
          </div>
          <div class="col-sm-6 col-md-3 text-center">
               <span class="glyphicon glyphicon-ok"></span> <br>
               Uy tín <br>
               Tiền là của bạn! Tiền sẽ được hoàn trả 100% nếu có vấn đề phát sinh.
          </div>
          <div class="col-sm-6 col-md-3 text-center">
               <span class="glyphicon glyphicon-check"></span> <br>
               Đảm bảo <br>
               Chúng tôi đảm bảo dịch vụ 100%. Nếu có bất kỳ vấn đề phát sinh nào, tiền của bạn sẽ được hoàn trả ngay lập tức. Hãy ngồi lại và tiếp tục mua sắm.
          </div>
          <div class="col-sm-6 col-md-3 text-center">
               <span class="glyphicon glyphicon-tags"></span> <br>
               5cloud <br>
               Lợi ích của khách hàng luôn đặt lên hàng đầu. Nếu chúng tôi không đạt được kỳ vọng của bạn, hãy cho chúng tôi biết.
          </div>
      </div>
</div>
